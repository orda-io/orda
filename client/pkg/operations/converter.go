...
func ModelToOperation(op *model2.Operation) iface.Operation {
	switch op.OpType {
	case model2.TypeOfOperation_COUNTER_SNAPSHOT,
		model2.TypeOfOperation_MAP_SNAPSHOT,
		model2.TypeOfOperation_LIST_SNAPSHOT,
		model2.TypeOfOperation_DOC_SNAPSHOT:
		return &SnapshotOperation{
			baseOperation: newBaseOperation(op.OpType, op.ID, op.Body),
		}
	case model2.TypeOfOperation_ERROR:
	...
	case model2.TypeOfOperation_DOC_ARR_DEL:
	...
	case model2.TypeOfOperation_DOC_ARR_UPD:
