...
func (suite *SimpleDatatypeSuite) TestOneOperationSyncWithTestWire() {
	...
	wg.Add(2)
	go intCounter1.DoTransaction("transaction1", func(intCounter commons.IntCounterInTransaction) error {
		defer wg.Done()
	...
	go intCounter1.DoTransaction("transaction2", func(intCounter commons.IntCounterInTransaction) error {
		defer wg.Done()
		intCounter.IncreaseBy(1)
		intCounter.IncreaseBy(2)
		intCounter.IncreaseBy(3)
